					...
					<div class="row">
						<div class="col-md-9 m-auto">
							...
							<div class="row">
								...
								<div class="col-lg-4 mb-3">
									<div class="card text-center doctor-book-card">
										<img src="<?=base_url('resources/user/')?>assets/img/img-pharmacy1.jpg" alt="" class="img-fluid">
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
							...
							<div class="specialities-slider slider">
								...
								<div class="speicality-item text-center">
									<div class="speicality-img">
										<img src="<?=base_url('resources/user/')?>assets/img/specialities/specialities-01.png" class="img-fluid" alt="Speciality">
								...
								<div class="speicality-item text-center">
									<div class="speicality-img">
										<img src="<?=base_url('resources/user/')?>assets/img/specialities/specialities-02.png" class="img-fluid" alt="Speciality">
										<span><i class="fa fa-circle" aria-hidden="true"></i></span>
									</div>
									<p>Neurology</p>	
								</div>							
								...
								<div class="speicality-item text-center">
									<div class="speicality-img">
										<img src="<?=base_url('resources/user/')?>assets/img/specialities/specialities-03.png" class="img-fluid" alt="Speciality">
										<span><i class="fa fa-circle" aria-hidden="true"></i></span>
									</div>	
									<p>Orthopedic</p>	
								</div>							
								...
								<div class="speicality-item text-center">
									<div class="speicality-img">
										<img src="<?=base_url('resources/user/')?>assets/img/specialities/specialities-04.png" class="img-fluid" alt="Speciality">
										<span><i class="fa fa-circle" aria-hidden="true"></i></span>
									</div>	
									<p>Cardiologist</p>	
								</div>							
								...
								<div class="speicality-item text-center">
									<div class="speicality-img">
										<img src="<?=base_url('resources/user/')?>assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">
										<span><i class="fa fa-circle" aria-hidden="true"></i></span>
									</div>	
									<p>Dentist</p>
								</div>							
						...
						<div class="col-lg-8">
							<div class="doctor-slider slider">
								...
								<div class="profile-widget">
									<div class="doc-img">
										<a href="doctor-profile.html">
											<img class="img-fluid" alt="User Image" src="<?=base_url('resources/user/')?>assets/img/doctors/doctor-07.jpg">
										</a>
										<a href="javascript:void(0)" class="fav-btn">
											<i class="far fa-bookmark"></i>
										</a>
				...
				<div class="container-fluid">
					...
					<div class="row blog-grid-row">
						<div class="col-md-6 col-lg-3 col-sm-12">
							...
							<div class="blog grid-blog">
								<div class="blog-image">
									<a href="blog-details.html"><img class="img-fluid" src="<?=base_url('resources/user/')?>assets/img/blog/blog-01.jpg" alt="Post Image"></a>
								</div>
								<div class="blog-content">
									<ul class="entry-meta meta-item">
										<li>
											<div class="post-author">
												<a href="doctor-profile.html"><img src="<?=base_url('resources/user/')?>assets/img/doctors/doctor-thumb-01.jpg" alt="Post Author"> <span>Dr. Ruby Perrin</span></a>
											</div>
										</li>
						...
						<div class="col-md-6 col-lg-3 col-sm-12">
							...
							<div class="blog grid-blog">
								<div class="blog-image">
									<a href="blog-details.html"><img class="img-fluid" src="<?=base_url('resources/user/')?>assets/img/blog/blog-02.jpg" alt="Post Image"></a>
								</div>
								<div class="blog-content">
									<ul class="entry-meta meta-item">
										<li>
											<div class="post-author">
												<a href="doctor-profile.html"><img src="<?=base_url('resources/user/')?>assets/img/doctors/doctor-thumb-02.jpg" alt="Post Author"> <span>Dr. Darren Elder</span></a>
											</div>
										</li>
						...
						<div class="col-md-6 col-lg-3 col-sm-12">
							...
							<div class="blog grid-blog">
								<div class="blog-image">
									<a href="blog-details.html"><img class="img-fluid" src="<?=base_url('resources/user/')?>assets/img/blog/blog-03.jpg" alt="Post Image"></a>
								</div>
								<div class="blog-content">
									<ul class="entry-meta meta-item">
										<li>
											<div class="post-author">
												<a href="doctor-profile.html"><img src="<?=base_url('resources/user/')?>assets/img/doctors/doctor-thumb-03.jpg" alt="Post Author"> <span>Dr. Deborah Angel</span></a>
											</div>
										</li>
										<li><i class="far fa-clock"></i> 3 Dec 2019</li>
									</ul>
						...
						<div class="col-md-6 col-lg-3 col-sm-12">
							...
							<div class="blog grid-blog">
								<div class="blog-image">
									<a href="blog-details.html"><img class="img-fluid" src="<?=base_url('resources/user/')?>assets/img/blog/blog-04.jpg" alt="Post Image"></a>
								</div>
								<div class="blog-content">
									<ul class="entry-meta meta-item">
										<li>
											<div class="post-author">
												<a href="doctor-profile.html"><img src="<?=base_url('resources/user/')?>assets/img/doctors/doctor-thumb-04.jpg" alt="Post Author"> <span>Dr. Sofia Brient</span></a>
											</div>
										</li>
