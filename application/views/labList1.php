					...
					<div class="modal-content">
						...
						<div class="modal-body">
								<div class="row form-row">
									<p><i class="fa fa-times fa-3x" style="color:red"></i> <b>First you need to Book an Appointment with a Doctor and Get Prescription!!</b></p> 
								</div>
								<a href="<?=site_url('patDoctor')?>" class="btn btn-primary btn-block">Find Doctor!</a>
						</div>
					</div>
				</div>
			</div>
