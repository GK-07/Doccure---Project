...
<head>
	...
	<body>
		<form action="<?=site_url('docPatient/addCaseFile/ccase')?>" method="post">
			<input type="text" name="txtDesc" hidden value="<?=$desc?>">
			<input type="text" name="txtPid" hidden value="<?=$pid?>">
			<textarea name="caseData">Make Sure Case File Shouldn't be blank..!!</textarea>
