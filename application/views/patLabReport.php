								...
								<div class="doc-info-left">
									<div class="doc-info-cont">
										<form method="post" id="report">
											<input type="text" name="txtLabid" value="<?=$laboratoryid?>" hidden>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <span><a style="width:8rem" href="<?=site_url('patDashboard/loadPatDashboard')?>" class="btn btn-success">Done!</a></span>
                    </div>
        ...
        <script type="text/javascript">
        	$(document).on('submit','#report',function(e){
        		$.ajax({
        			type:'POST',
        			data:$(this).serialize(),
        			url:"<?=site_url('patDoctor/addReport1')?>",
        			success:function()
        			{
