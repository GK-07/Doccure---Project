	...
	<body>
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body">
									...
									<!-- Social Form -->
									<form method="post" action="<?=site_url('docHome/editSocial')?>" id="social">                                                                                           
										<div class="row">
											<div class="col-md-12 col-lg-8">
												<div class="form-group">
													<label>Facebook URL</label>
													<input type="text" name="txtFacebook" value="<?=$sdata[0]->facebook?>"class="form-control" >
												</div>
											</div>
										</div>
										<div id="warn"></div>
										<div class="row">
											<div class="col-md-12 col-lg-8">
												<div class="form-group">
													...
													<input type="text" name="txtTwitter" class="form-control" value="<?=$sdata[0]->twitter?>">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12 col-lg-8">
												<div class="form-group">
													...
													<input type="text" name="txtInsta" class="form-control" value="<?=$sdata[0]->instagram?>">
												</div>
											</div>
										</div>
		...
		<script type="text/javascript">
			$(document).on('submit','#social',function(e){
				if($('input[name="txtFacebook"]').val()=="")
				{
					$('#warn').html('<p style="color:red;">This fields is required</p>');
					return false;
				}
				else{
					$('#warn').html('');	
