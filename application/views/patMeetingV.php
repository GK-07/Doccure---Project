																	...
																	<tr>
																		...
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="patient-profile.html"><?=$m->fullname?><span>#<?=$m->appointmentid?></span></a>
																			</h2>
																		</td>
																		<td><?=$m->adesc?></td>
																		<td><form action="<?=site_url('patMeeting/loadRoom/'.$m->roomid)?>"><button disabled type="submit" class="btn" style="background-color: #20c0f3; color:white;" id="<?=$id?>">Join Meeting</button></form></td>
																		<script type="text/javascript">
